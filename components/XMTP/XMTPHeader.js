export function XMTPHead(){
    return <div class="chat-header px-6 py-4 flex flex-row flex-none justify-between items-center shadow">
    <div class="flex">
    ...
    <div class="flex">
        ...
        <a
            href="#"
            class="block rounded-full hover:bg-gray-200 bg-gray-100 w-10 h-10 p-2 ml-4"
        >
            <svg
                viewBox="0 0 20 20"
                class="w-full h-full fill-current text-blue-600"
